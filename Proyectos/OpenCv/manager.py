...
from assets.screens.umbralizacion import umbralizacion
from assets.screens.videoCap import videoCap

class ventana(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("OpenCv - Programas")
        ...
        pantallas=(home,umbralizacion,videoCap)       #Carga de pantallas
